...
In the cases $n=2,3$, such a 2-functor has recently been studied by Mackaay, Pan and Tubbenhauer \cite{1206.2118} and by Lauda and Rose \cite{LRQ}. 

\vspace{.5cm}

\noindent {\bf Acknowledgments:}
The authors benefited from discussions with \todo{NEED}. S.C. was supported by NSF grant DMS-1101439 and the Alfred P. Sloan foundation, S.M. was supported by the Australian Reseach Council grant DECRA ??? and by DARPA ???. \todo{NEED}. 
